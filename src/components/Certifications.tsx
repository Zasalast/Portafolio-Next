...
export default function Certifications() {
  ...
  return (
    <section id="certificaciones" className="section-padding bg-background-secondary/30">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto">
            Cursos, certificaciones y formaciones continuas en tecnologías y habilidades blandas.
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-md mx-auto mb-6">
            ...
            <input
              ...
              className="w-full card pl-12 pr-4 py-3"
            />
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  selectedCategory === category
                    ...
                    : "card hover:border-accent-primary"
                }`}
              >
                {category}
              </button>
          ...
          {filteredCertifications.map((cert) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-text-muted text-sm">{cert.provider}</span>
